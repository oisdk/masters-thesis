...
𝕃⇔ℒ⟨ℰ⟩ .rightInv (sup , cov) = Σ≡Prop (λ xs x y i t → squash (x t) (y t) i) (𝕃⇔ℒ .rightInv sup)
𝕃⇔ℒ⟨ℰ⟩ .leftInv  (sup , cov) = Σ≡Prop (λ xs x y i t → squash (x t) (y t) i) (𝕃⇔ℒ .leftInv sup)
