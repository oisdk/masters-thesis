...
In this definition we refer to lists, and their membership: 
...
This is the definition of a list as a \emph{container} (\Cref{container-def}):
...
Containers themselves have the following definition:
...
To prohibit duplicates, we will insist that every
...
preferred~\citep[definition 4.6.1]{hottbook}:
\begin{multicols}{2}
