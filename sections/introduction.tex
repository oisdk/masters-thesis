...
\cite{huttonCountdownProblem2002}: this is a somewhat famous puzzle where
...
\cite{norellDependentlyTypedProgramming2008}, Coq
\cite{thecoqdevelopmentteamCoqProofAssistant2020}, or Idris
\cite{bradyIdrisGeneralpurposeDependently2013}, allow us to compile and
\emph{run} our proofs.
