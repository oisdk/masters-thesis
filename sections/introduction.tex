...
also have to specify some order on the underlying type. \todo{clean up phrasing here}
...
The specific constructive setting this thesis will operate in is Cubical Type
Theory \cite{cohenCubicalTypeTheory2016}: this is a type theory which allows for
constructive interpretation of the univalence axiom \cite{hottbook} \todo{should
this be the hottbook or something else?}, an axiom which allows us to treat
