...
\begin{description}
  \item[A classification of five finiteness predicates in Cubical Type Theory.]
    ...
    Homotopy Type Theory \citep{fruminFiniteSetsHomotopy2018}; this work defines
  ...
  \item[Proof of implication between finiteness predicates.]
    ...
    cardinal finiteness and manifest Bishop finiteness is present informally
    in \cite{yorgeyCombinatorialSpeciesLabelled2014}, and formally (though in
    HoTT) in \cite{fruminFiniteSetsHomotopy2018}).
    Theorem~\ref{cardinal-to-manifest-bishop} in particular has not been proven
    formally before.
...
\begin{definition}[ZFC]
  ...
  rest of Zermely-Fraenkel set theory: when included the theory is often
  abbreviated to ``ZFC''.
