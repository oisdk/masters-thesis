...
\begin{marginfigure}
  \begin{tikzpicture}
    \draw (-1,0) node[above] {$x$} node[below] {\AgdaFunction{i0}} --
          ( 0,0) node[above] {\AgdaFunction{\(\equiv\)}} --
          ( 1,0) node[above] {$y$} node[below] {\AgdaFunction{i1}};
    \filldraw[black] (-1,0) circle (2pt);
    \filldraw[black] (1,0) circle (2pt);
  \end{tikzpicture}
  \caption{Diagram of the Path Between \(x\) and \(y\)}
  \label{path-diagram}
\end{marginfigure}
