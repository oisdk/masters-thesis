\chapter{Programming and Proving in Cubical Agda} \label{agda-intro} Agda \citep{norellDependentlyTypedProgramming2008} is a dependently-typed, pure,
...
\begin{agdalisting*}
  \begin{multicols}{2} \centering
    \ExecuteMetaData[agda/Snippets/Bool.tex]{boolean} \columnbreak
    \ExecuteMetaData[haskell/Bool.tex]{boolean-synonym}
...
\end{agdalisting*}
\section{The Menagerie of Foundational Theories}
...
\section{Comparing Classical And Constructive Proofs in Agda}
...
\(\AgdaDatatype{\(\Sigma\)}\;\agdambb{N}\;\lambda\;\AgdaBound{n}\rightarrow
...
\begin{agdalisting*}
  \ExecuteMetaData[agda/Snippets/Classical.tex]{doubleneg-elim}
\end{agdalisting*}
...
\begin{agdalisting}
  \ExecuteMetaData[agda/Snippets/Classical.tex]{classical-def}
\end{agdalisting}
...
\begin{agdalisting*}
  \ExecuteMetaData[agda/Snippets/Classical.tex]{lem-proof}
\end{agdalisting*}
This type forms a monad, meaning that it implements the following functions:
\begin{agdalisting*}
  \ExecuteMetaData[agda/Snippets/Classical.tex]{monad}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaData[agda/Relation/Nullary/Stable.tex]{stable-def}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaData[agda/Snippets/Complexity.tex]{f-def}
\end{agdalisting*}
