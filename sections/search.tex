...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Snippets/Bool.tex]{and-def}
\end{agdalisting*}
...
\begin{agdalisting} \label{bool-assoc-auto-proof}
  \ExecuteMetaDataInline[agda/Snippets/Bool.tex]{bool-assoc-auto-proof}
\end{agdalisting}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Snippets/Bool.tex]{some-assoc}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Snippets/Bool.tex]{obvious}
\end{agdalisting*}
...
\begin{multicols}{2}
  \begin{agdalisting*}
    \ExecuteMetaDataInline[agda/Snippets/Bool.tex]{is-true}
  \end{agdalisting*} \columnbreak
  \begin{agdalisting*}
    \ExecuteMetaDataInline[agda/Snippets/Bool.tex]{from-true}
  \end{agdalisting*}
\end{multicols}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Snippets/Bool.tex]{extremely-obvious}
\end{agdalisting*}
...
``Exhaustibility''.
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Relation/Nullary/Omniscience.tex]{exhaustible}
\end{agdalisting*}
...
\emph{omniscience}.
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Relation/Nullary/Omniscience.tex]{omniscient}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Relation/Nullary/Decidable/Properties.tex]{dec-double-neg-elim}
\end{agdalisting*}
All together, this gives us the following proof:
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Relation/Nullary/Omniscience.tex]{omniscient-to-exhaustible}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Relation/Nullary/Omniscience.tex]{prop-omniscient}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Cardinality/Finite/Kuratowski.tex]{kuratowski-prop-omniscient}
\end{agdalisting*}
...
\begin{minipage}{\linewidth}
  \begin{multicols}{2}
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Cardinality/Finite/SplitEnumerable/Search.tex]{forall-ask}
    \end{agdalisting*} \columnbreak
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Cardinality/Finite/SplitEnumerable/Search.tex]{exists-ask}
    \end{agdalisting*}
  \end{multicols}
\end{minipage}
...
\begin{minipage}{\linewidth}
  \begin{multicols}{2}
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Cardinality/Finite/SplitEnumerable/Search.tex]{forall-zap}
    \end{agdalisting*} \columnbreak
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Cardinality/Finite/SplitEnumerable/Search.tex]{exists-zap}
    \end{agdalisting*}
  \end{multicols}
\end{minipage}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Snippets/Bool.tex]{pre-inst-proof}
\end{agdalisting*}
...
\begin{minipage}{\linewidth}
  \begin{multicols}{2}
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Cardinality/Finite/SplitEnumerable/Search.tex]{forall-zap-inst}
    \end{agdalisting*} \columnbreak
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Cardinality/Finite/SplitEnumerable/Search.tex]{exists-zap-inst}
    \end{agdalisting*}
  \end{multicols}
\end{minipage}
And this also changes the idempotency proof to the following:
\begin{agdalisting}
  \ExecuteMetaDataInline[agda/Snippets/Bool.tex]{with-inst-proof}
\end{agdalisting}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Snippets/Bool.tex]{and-comm}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Snippets/Bool.tex]{finite-sigma-inst}
\end{agdalisting*}

The \AgdaFunction{it} function here is a clever helper function.
It's defined like so:
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Instance.tex]{it-def}
\end{agdalisting*}
...
\begin{minipage}{\linewidth}
  \begin{multicols}{2}
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Data/Product/NAry.tex]{levels}
    \end{agdalisting*} \columnbreak
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Data/Product/NAry.tex]{max-level}
...
levels of each type):
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Data/Product/NAry.tex]{types}
\end{agdalisting*}
...
\begin{minipage}{\linewidth}
  \begin{multicols}{2}
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Data/Product/NAry.tex]{tuple-plus}
    \end{agdalisting*} \columnbreak
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Data/Product/NAry.tex]{tuple}
    \end{agdalisting*}
  \end{multicols}
\end{minipage}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Data/Product/NAry.tex]{pi-arrs-plus}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Data/Product/NAry.tex]{full-iso}
\end{agdalisting*}
...
each of the types.
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Cardinality/Finite/SplitEnumerable/Search.tex]{exists-q-n}
\end{agdalisting*}
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Cardinality/Finite/SplitEnumerable/Search.tex]{exists-zap-n}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Snippets/Bool.tex]{and-comm-auto}
\end{agdalisting*}
...
itself finite.
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Countdown.tex]{vec-fin}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Countdown.tex]{op-fin}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Countdown.tex]{wrong-perm}
\end{agdalisting*}
...
In types:
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Countdown.tex]{iso-perm}
\end{agdalisting*}
Where an isomorphism is defined as follows:
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Countdown.tex]{isomorphism}
\end{agdalisting*}
...
these predicates to be decidable. \todo{Need to do filter subobject in topos subsection}
We will construct a term of the following type:
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Cardinality/Finite/ManifestBishop.tex]{dec-type}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Cardinality/Finite/ManifestBishop.tex]{iso-finite}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Countdown.tex]{perm-def}
\end{agdalisting*}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Countdown.tex]{perm-fin}
\end{agdalisting*}
...
\begin{definition}[Dyck words]
  ...
  \begin{agdalisting*}
    \ExecuteMetaDataInline[agda/Dyck.tex]{dyck-def}
  \end{agdalisting*}
  ...
  \begin{multicols}{2}
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Dyck.tex]{dyck-0-2}
    \end{agdalisting*}
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Dyck.tex]{dyck-0-3}
    \end{agdalisting*}
  \end{multicols}
  The first parameter on the type represents the amount of unbalanced closing
  parens, for instance:
  \begin{agdalisting*}
    \ExecuteMetaDataInline[agda/Dyck.tex]{dyck-1-2}
  \end{agdalisting*}
\end{definition}
...
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Dyck.tex]{tree-simpl-def}
\end{agdalisting*}
The algorithm itself is quite similar to stack-based parsing algorithms.
\begin{agdalisting*}
  \ExecuteMetaDataInline[agda/Dyck.tex]{from-dyck}
\end{agdalisting*}
...
\begin{minipage}{\linewidth}
  \begin{multicols}{2}
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Countdown.tex]{eval}
    \end{agdalisting*} \columnbreak
    \begin{agdalisting*}
      \ExecuteMetaDataInline[agda/Countdown.tex]{app-op}
    \end{agdalisting*}
